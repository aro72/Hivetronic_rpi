...
uint8_t SX1272::setACK()
{
	...
	ACK.data[2]= 0x01; /* ACK_NTP_CODE*/
        ACK.data[3]= currentTime->tm_sec;
        ACK.data[4]= currentTime->tm_min;
        ACK.data[5]= currentTime->tm_hour;
        ACK.data[6]= currentTime->tm_mday;
        ACK.data[7]= currentTime->tm_mon;
        ACK.data[8]= currentTime->tm_year;
        ACK.data[9]= currentTime->tm_wday;
	ACK.data[10]= 0x02; /* ACK_PERIOD_CODE */
	ACK.data[11]= 0x00; /*reporting period MSB in second */
	ACK.data[12]= 0x00;
	ACK.data[13]= 0x00;
	ACK.data[14]= 0x02; /*reporting period LSB*/
        ...
        writeRegister(REG_FIFO, ACK.data[2]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[3]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[4]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[5]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[6]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[7]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[8]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[9]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[10]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[11]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[12]);   // Writing the ACK in FIFO
        writeRegister(REG_FIFO, ACK.data[13]);   // Writing the ACK in FIFO
